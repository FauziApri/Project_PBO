...
5.) Setelah itu ubah saja filenya menjadi .env agar bisa di RUN (buat baru juga boleh)
...
1.) Masuk ke Netbeans
2.) Pada project java VehicleRent, cek disitu ada folder 'Libraries' (hanya bisa dilihat di Netbeans kalian)
